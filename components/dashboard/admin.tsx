  ...
  return (
    <div>
      {windowSize.width > 730 ? (
        <div className="w-screen bg-white dark:bg-[#222]">
          <aside
            id="sidebar"
            className="fixed left-0 top-0 z-40 h-screen w-64 transition-transform"
            aria-label="Sidebar"
          >
            <div className="flex h-full flex-col overflow-y-auto border-r border-slate-200 bg-white px-3 py-4 dark:border-slate-700 dark:bg-[#222]">
                      ...
                      <g data-name="Layer 2">
                        <g data-name="sun">
                          <rect
                            ...
                            opacity="0"
                          />
                          <path className="dark:stroke-white" d="M12 6a1 1 0 0 0 1-1V3a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1z" />
                          <path className="dark:stroke-white" d="M21 11h-2a1 1 0 0 0 0 2h2a1 1 0 0 0 0-2z" />
                          <path className="dark:stroke-white" d="M6 12a1 1 0 0 0-1-1H3a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1z" />
                          <path className="dark:stroke-white" d="M6.22 5a1 1 0 0 0-1.39 1.47l1.44 1.39a1 1 0 0 0 .73.28 1 1 0 0 0 .72-.31 1 1 0 0 0 0-1.41z" />
                          <path className="dark:stroke-white" d="M17 8.14a1 1 0 0 0 .69-.28l1.44-1.39A1 1 0 0 0 17.78 5l-1.44 1.42a1 1 0 0 0 0 1.41 1 1 0 0 0 .66.31z" />
                          <path className="dark:stroke-white" d="M12 18a1 1 0 0 0-1 1v2a1 1 0 0 0 2 0v-2a1 1 0 0 0-1-1z" />
                          <path className="dark:stroke-white" d="M17.73 16.14a1 1 0 0 0-1.39 1.44L17.78 19a1 1 0 0 0 .69.28 1 1 0 0 0 .72-.3 1 1 0 0 0 0-1.42z" />
                          <path className="dark:stroke-white" d="M6.27 16.14l-1.44 1.39a1 1 0 0 0 0 1.42 1 1 0 0 0 .72.3 1 1 0 0 0 .67-.25l1.44-1.39a1 1 0 0 0-1.39-1.44z" />
                          <path className="dark:stroke-white" d="M12 8a4 4 0 1 0 4 4 4 4 0 0 0-4-4z" />
                        </g>
                      </g>
                    </svg>
                    <span className="ml-3 flex-1 whitespace-nowrap">
        ...
        <div className="dark:bg-[#222]">{props.pages}</div>
      )}
    </div>
  );
}
